      ...
      success: function (data) {
        $.each(data, function (i, v) {
          if (v.content.slice(v.content.length - 3) === "mp4") {
            var div_slides_html =
              '<div class="mySlides fade"><video width="640" controls="controls" preload="metadata"><source src="/media/ ' +
              v.content +
              '#t=0.5" type="video/mp4"></video></div>';
          } else {
            var div_slides_html =
              '<div class="mySlides fade"><img src="/media/' +
              v.content +
          ...
          // $('#storiestitle').append(div_slides_html);
        });
      },
      complete: function () {
